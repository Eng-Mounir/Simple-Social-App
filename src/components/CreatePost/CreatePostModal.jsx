        ...
        {(onClose) => (
          <div className="bg-white dark:bg-neutral-900 rounded-3xl overflow-hidden max-h-[80vh] flex flex-col">
            ...
            <div className="px-6 py-5 space-y-5 overflow-auto">
              ...
              <div className="border-2 border-dashed border-gray-300 dark:border-neutral-700 rounded-2xl h-44 flex items-center justify-center text-gray-400 text-sm">
              ...
              <div className="flex flex-wrap gap-3 justify-between">
                <ActionButton icon={<FaImage />} label="Photo" color="text-green-500" />
...
function ActionButton({ icon, label, color }) {
  return (
    <button className="flex items-center gap-2 px-4 py-2 rounded-xl hover:bg-gray-100 dark:hover:bg-neutral-800 transition text-sm font-medium">
